...
const files = [
  ...
  // T11-i（全资产搜索 + 侧栏命令面板 B″）新增/改动件 —— 纳入清单（F73/F88 纪律：新件即入册）
  'apps/web/src/components/search/AssetSearch.tsx',
  'apps/web/src/pages/Search.tsx',
  'apps/web/src/components/market/sortOptions.ts',
  'apps/web/src/components/ui/CommandPalette.tsx',
  'apps/web/src/components/ui/navItems.tsx',
  'apps/web/src/components/ui/SideNav.tsx',
  'apps/web/src/components/ui/TopBar.tsx',
  'apps/web/src/components/market/Hero.tsx',
