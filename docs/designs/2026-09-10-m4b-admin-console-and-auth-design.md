...
> Date: 2026-09-10
> Updated: 2026-09-16（**v1.28：M4b-2 批内执行进度回填（T1-T8 ✅）**——§2.3 登记表 M4b-2 行「批内进度」
