...
> Date: 2026-09-10
> Updated: 2026-09-16（**v1.31：新增 M4b-7「控制台视觉打磨批」（用户拍板 A）**——§2.3 拆批表 + backlog 表 + 
