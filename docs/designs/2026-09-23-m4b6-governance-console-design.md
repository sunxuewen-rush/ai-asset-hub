...
> Date: 2026-09-23
> Updated: 2026-09-24（**v0.42：F219 跨批断言修复 + 造数复位收口** —— ① **F219**：`m4b4` dogfood 两条断言侧缺陷修掉（`G20-9` 行数改**端点真值**；`G6` 文案改「**已上线**」）+ 夹具复位修其余 4 条 ⇒ `m4b4` **83/6 → 89/0** ✅ ② **造数复位**（用户授权写库）：`m4b3` **43/0** · `m4b5` **62/0** · 本批 dogfood **102/0** 复跑不变 ⇒ **零回归 21 → 2 条**（余 `m4a` 2 条需「两份可比版本」前置，非本批）③ 证据 §4/§6/§8 + 批 plan §7 同步）
