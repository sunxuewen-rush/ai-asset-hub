...
> Date: 2026-09-23
> Updated: 2026-09-24（**v0.44：F220 `m4a` 跨批断言真值化** —— 挂账 ① 收口：`m4a` 两条（`diff 三型徽章` / `diff +/− 行内容`）定性为**断言过时**（真值口径 = `+N/−M` 签名 · 非字面词；原 `searchByPrefix` 命中来自「变更历史」= 假命中）⇒ 修为**真值口径 + 真源取证** ⇒ `m4a` **58/2 → 60/0** ✅（含正反双证）；零回归四脚本 **60/0 · 43/0 · 89/0 · 62/0** 全绿 · **挂账失败项 2 → 0**）
...
### 9.8 实施期发现与处置（F203–**F220** · 实现批 T1–T10 + 收口轮）
