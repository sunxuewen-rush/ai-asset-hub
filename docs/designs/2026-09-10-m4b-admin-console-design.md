...
|----|------------------------|----------------------|------|------|----------------|
| **M4b-pre** | `2026-09-15-m4b-pre-auth-migration-design.md` | `M4b-pre-auth-migration.md` | design **v2.1**（执行期回写后） · plan **v0.11** | 🔵 **执行中（T1-T6 ✅ 已推送，T7-T8 收尾）**——spike **✅ X1-X8 全通过** · design 定稿并整体批准（8 维 **9.44**，后经 T2-T6 落地回写至 v2.1）· 七个提交 `fd58de0`/`a7ce23e`/`fb7b4a7`/`7b8ea11`/`b76e978`/`a6c2c5a`/`50b0c52`，**CI #41-#47 全绿**；全量测试 **501 例 0 fail**；批内自绘面 = 企业目录凭证插件 + 业务面同源守卫（理由见 design §1.4/§2.3 P14） | ⬜ ① design 8 维 ≥9 ✅（9.44，T8 converge 终评）② T1-T8 全绿 ⬜（T1-T6 ✅）③ 五门禁 ✅（T6 末次全绿）④ dogfood/观感 ⬜（T8 人工项）⑤ 整体审计 ⬜（T8） |
...
| **M4b-2** | ⬜ 待落地回填 | ⬜ 待落地回填 | — | ⏸ **暂停 2026-09-15（用户拍板）**——认证底座以 **M4b-pre** 结论为前置，M4b 整体顺延；本批**未动工零代码** | ⬜ |
