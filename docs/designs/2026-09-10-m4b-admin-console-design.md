...
|----|------------------------|----------------------|------|------|----------------|
| **M4b-pre** | `2026-09-15-m4b-pre-auth-migration-design.md` | `M4b-pre-auth-migration.md` | design **v1.3**（定稿·已批准） · plan **v0.2** | ⬜ **计划已立（2026-09-15）**——认证整车（better-auth）迁移**前置批**（用户 2026-09-15 拍板前置）：spike **✅ X1-X8 全通过** · design 定稿并整体批准（8 维 **9.44**）· plan 立项 **T1-T9**；批内自绘面仅 1 处（企业目录凭证插件，理由见 design §1.4） | ⬜（T1 起跑后逐件登记） |
