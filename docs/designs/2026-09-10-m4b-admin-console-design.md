...
|----|------------------------|----------------------|------|------|----------------|
| **M4b-pre** | —（**spike 裁定前不立**） | —（同上） | — | ⬜ **评估中（spike 待跑）**——认证整车（better-auth）迁移**前置批**（用户 2026-09-15 拍板前置）；定案后本表回填实际件名 | ⬜ |
