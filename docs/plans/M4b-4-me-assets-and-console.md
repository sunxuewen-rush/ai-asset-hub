...
> Updated: 2026-09-21（**v0.45：`j5` 门户笔收口** —— ① 断言改写（`G20-3` 真值口径 · `G20-4` 7 格 · **+`G20-10`** · `G22-3` 两档 · **删 `G22-6`** · `G22-7` 三列 · `G6` 本批锚定）② 首跑 **85/4** 如实留痕（**F119** 跨批夹具 · **F120** 删除的 setup 副作用）⇒ 修完复跑 **`m4b4` 89/0** · **`m4a` 60/0**（零回归）· `m4b3` **39/0** · **89 = 91 − 1 + 1 − 2** 逐项对上 ③ CI 同序八步全绿（`test` **559 pass / 0 fail**）· 证据件 **611 行** + 11 图 ④ §7.5 **T11-j ✅ 全绿**（门户笔收口）⑤ 依据 = 批 design **v1.16**（8 维 **9.38**））
