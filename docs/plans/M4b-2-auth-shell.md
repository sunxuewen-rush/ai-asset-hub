...
| F3 | 已删件 / 原型残留 | `AuthLayout` 34 处 = 文档 31 + **代码 3 处均为注释说明「已删件」（非引用）**；`M4b2UiProto` / `__proto` = 原型本体 1 + 证据 2（**待用户授权删除**，已登记） | 维持（授权后删） |
