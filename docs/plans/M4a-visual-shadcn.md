...
> 引用链：本文档 → 设计 `docs/designs/2026-09-09-m4a-marketplace-portal-design.md` **v0.23**（§N 逐 Task 引用）→ 规范 00 §5 · 07（引用不复制，契约以 design v0.23 为准）
...
- **converge 三查（实测）**：① **版本头**——design `v0.23` · plan `v0.23` · `00` `v1.19` 三向互指一致 ✓
  ...
  44 项零消费者）· §8 补「阶段 1 换皮完成」段 · §11 同步；**跨文档**：M2 design 加失效标注行（正文不改）·
