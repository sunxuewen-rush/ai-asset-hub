...
- **M4b-2 🔵 执行中**（认证与壳批：登录页 `/login` · 设备授权页 `/device` · 会话上下文 · 401 分流 · 侧栏三组 + 用户区 · 路由骨架 11 条）：`docs/designs/2026-09-16-m4b2-auth-shell-design.md` + `docs/plans/M4b-2-auth-shell.md`（**版本以各自版本头为准** · **T1-T3 ✅** / T4-T10 ⬜ · 批内进度见批 plan）——**服务端改动 0 行 · 新增依赖 0 个**
